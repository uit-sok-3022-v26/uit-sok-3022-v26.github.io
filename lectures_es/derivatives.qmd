...
$$
S_t = S_0 \cdot e^{\mu \cdot t-\tfrac{1}{2} \sigma^2 t + \sigma \cdot z_t}
$$
we have a model that correctly captures the expected value of the stock price, accounting for both the drift and the volatility of the process so that
$$
\mathbb{E}[S_t] = S_0 \cdot e^{\mu \cdot t}
$$ {#eq-correct_exp3}
